...
artist1_portrait = open('https://tonify-seeds.s3.amazonaws.com/Chance+The+Rapper/chance-portrait.jpeg')
artist1_banner = open('https://tonify-seeds.s3.amazonaws.com/Chance+The+Rapper/chance_banner.jpg')
artist1_bio_photo = open('https://tonify-seeds.s3.amazonaws.com/Chance+The+Rapper/chance-bio.jpeg')
...
artist2_bio_photo = open('https://tonify-seeds.s3.amazonaws.com/Ariana+Grande/ariana-bio.png')
...
artist3_portrait = open('https://tonify-seeds.s3.amazonaws.com/Jay+Park/jay-park-profile.jpeg')
artist3_banner = open('https://tonify-seeds.s3.amazonaws.com/Jay+Park/jay-park-banner.jpg')
artist3_bio_photo = open('https://tonify-seeds.s3.amazonaws.com/Jay+Park/jay-park-bio.jpeg')
...
artist4_portrait = open('https://tonify-seeds.s3.amazonaws.com/blink-182/blink-182-profile.jpeg')
artist4_banner = open('https://tonify-seeds.s3.amazonaws.com/blink-182/blink-182-banner.jpeg')
artist4_bio_photo = open('https://tonify-seeds.s3.amazonaws.com/blink-182/blink-182-bio.jpeg')
...
artist5_portrait = open('https://tonify-seeds.s3.amazonaws.com/Mac+Miller/mac-miller-portrait.jpg')
artist5_banner = open('https://tonify-seeds.s3.amazonaws.com/Mac+Miller/mac-miller-banner.jpeg')
artist5_bio_photo = open('https://tonify-seeds.s3.amazonaws.com/Mac+Miller/mac-miller-bio.jpg')
...
album1_art = open('https://tonify-seeds.s3.amazonaws.com/Chance+The+Rapper/Coloring_Book.jpg')
...
album3_art = open('https://tonify-seeds.s3.amazonaws.com/Ariana+Grande/Justin_Bieber_and_Ariana_Grande_-_Stuck_with_You.png')
...
album4_art = open('https://tonify-seeds.s3.amazonaws.com/Jay+Park/yacht.jpg')
...
album5_art = open('https://tonify-seeds.s3.amazonaws.com/Jay+Park/Jay_Park_-_Joah.png')
...
album6_art = open('https://tonify-seeds.s3.amazonaws.com/album_art/blink-182/blink-182-album-art.jpeg')
...
album7_art = open('https://tonify-seeds.s3.amazonaws.com/Mac+Miller/00+-+Mac_Miller_Kids-front-large.jpg')
...
song17_audio = open('https://tonify-seeds.s3.amazonaws.com/Ariana+Grande/Ariana+Grande%2C+Justin+Bieber+-+Stuck+With+U+(Lyrics).mp3')

# Jay Park Songs
song18_audio = open('https://tonify-seeds.s3.amazonaws.com/Jay+Park/Jay+Park+-+Yacht+(K)+(Feat.+Sik-K).mp3') 
song19_audio = open('https://tonify-seeds.s3.amazonaws.com/Jay+Park/%EC%A2%8B%EC%95%84+Joah+(Remastered).mp3') 

# blink-182 Songs
song20_audio = open('https://tonify-seeds.s3.amazonaws.com/blink-182/2003+-+Blink-182/01+-+Feeling+This.mp3') 
song21_audio = open('https://tonify-seeds.s3.amazonaws.com/blink-182/2003+-+Blink-182/02+-+Obvious.mp3') 
song22_audio = open('https://tonify-seeds.s3.amazonaws.com/blink-182/2003+-+Blink-182/03+-+I+Miss+You.mp3') 
song23_audio = open('https://tonify-seeds.s3.amazonaws.com/blink-182/2003+-+Blink-182/04+-+Violence.mp3') 
song24_audio = open('https://tonify-seeds.s3.amazonaws.com/blink-182/2003+-+Blink-182/05+-+Stockholm+Syndrome.mp3') 
song25_audio = open('https://tonify-seeds.s3.amazonaws.com/blink-182/2003+-+Blink-182/06+-+Down.mp3') 
song26_audio = open('https://tonify-seeds.s3.amazonaws.com/blink-182/2003+-+Blink-182/07+-+The+Fallen+Interlude.mp3') 
song27_audio = open('https://tonify-seeds.s3.amazonaws.com/blink-182/2003+-+Blink-182/08+-+Go.mp3') 
song28_audio = open('https://tonify-seeds.s3.amazonaws.com/blink-182/2003+-+Blink-182/09+-+Asthenia.mp3') 
song29_audio = open('https://tonify-seeds.s3.amazonaws.com/blink-182/2003+-+Blink-182/10+-+Always.mp3') 
song30_audio = open('https://tonify-seeds.s3.amazonaws.com/blink-182/2003+-+Blink-182/11+-+Easy+Target.mp3') 
song31_audio = open('https://tonify-seeds.s3.amazonaws.com/blink-182/2003+-+Blink-182/12+-+All+Of+This.mp3') 
song32_audio = open('https://tonify-seeds.s3.amazonaws.com/blink-182/2003+-+Blink-182/13+-+Heres+Your+Letter.mp3')
song33_audio = open('https://tonify-seeds.s3.amazonaws.com/blink-182/2003+-+Blink-182/14+-+Im+Lost+Without+You.mp3')

# Mac Miller Songs
song34_audio = open('https://tonify-seeds.s3.amazonaws.com/Mac+Miller/Mac+Miller+-+KIDS+(DatPiff.com)/01+-+Kickin+Incredibly+Dope+Shit+(Intro)+(DatPiff+Exclusive).mp3')
song35_audio = open('https://tonify-seeds.s3.amazonaws.com/Mac+Miller/Mac+Miller+-+KIDS+(DatPiff.com)/02+-+Outside+(DatPiff+Exclusive).mp3')
song36_audio = open('https://tonify-seeds.s3.amazonaws.com/Mac+Miller/Mac+Miller+-+KIDS+(DatPiff.com)/03+-+Get+Em+Up+(DatPiff+Exclusive).mp3')
song37_audio = open('https://tonify-seeds.s3.amazonaws.com/Mac+Miller/Mac+Miller+-+KIDS+(DatPiff.com)/04+-+Nikes+On+My+Feet+(DatPiff+Exclusive).mp3')
song38_audio = open('https://tonify-seeds.s3.amazonaws.com/Mac+Miller/Mac+Miller+-+KIDS+(DatPiff.com)/05+-+Senior+Skip+Day+(DatPiff+Exclusive).mp3')
song39_audio = open('https://tonify-seeds.s3.amazonaws.com/Mac+Miller/Mac+Miller+-+KIDS+(DatPiff.com)/06+-+The+Spins+(DatPiff+Exclusive).mp3')
song40_audio = open('https://tonify-seeds.s3.amazonaws.com/Mac+Miller/Mac+Miller+-+KIDS+(DatPiff.com)/07+-+Traffic+In+The+Sky+(DatPiff+Exclusive).mp3')
song41_audio = open('https://tonify-seeds.s3.amazonaws.com/Mac+Miller/Mac+Miller+-+KIDS+(DatPiff.com)/08+-+Dont+Mind+If+I+Do+(DatPiff+Exclusive).mp3')
song42_audio = open('https://tonify-seeds.s3.amazonaws.com/Mac+Miller/Mac+Miller+-+KIDS+(DatPiff.com)/09+-+Paper+Route+feat+Chevy+Woods+(DatPiff+Exclusive).mp3')
song43_audio = open('https://tonify-seeds.s3.amazonaws.com/Mac+Miller/Mac+Miller+-+KIDS+(DatPiff.com)/10+-+Good+Evening+(DatPiff+Exclusive).mp3')
song44_audio = open('https://tonify-seeds.s3.amazonaws.com/Mac+Miller/Mac+Miller+-+KIDS+(DatPiff.com)/11+-+Ride+Around+(DatPiff+Exclusive).mp3')
song45_audio = open('https://tonify-seeds.s3.amazonaws.com/Mac+Miller/Mac+Miller+-+KIDS+(DatPiff.com)/12+-+Knock+Knock+(DatPiff+Exclusive).mp3')
song46_audio = open('https://tonify-seeds.s3.amazonaws.com/Mac+Miller/Mac+Miller+-+KIDS+(DatPiff.com)/13+-+Mad+Flava+Heavy+Flow+(Interlude)+feat+DJ+Bonics+(DatPiff+Exclusive).mp3')
song47_audio = open('https://tonify-seeds.s3.amazonaws.com/Mac+Miller/Mac+Miller+-+KIDS+(DatPiff.com)/14+-+Kool+Aid+%26+Frozen+Pizza+(DatPiff+Exclusive).mp3')
song48_audio = open('https://tonify-seeds.s3.amazonaws.com/Mac+Miller/Mac+Miller+-+KIDS+(DatPiff.com)/15+-+All+I+Want+Is+You+(DatPiff+Exclusive).mp3')
song49_audio = open('https://tonify-seeds.s3.amazonaws.com/Mac+Miller/Mac+Miller+-+KIDS+(DatPiff.com)/16+-+Poppy+(DatPiff+Exclusive).mp3')
song50_audio = open('https://tonify-seeds.s3.amazonaws.com/Mac+Miller/Mac+Miller+-+KIDS+(DatPiff.com)/17+-+Face+In+The+Crowd+(DatPiff+Exclusive).mp3')
...
playlist_photo1 = open('https://tonify-seeds.s3.amazonaws.com/default_playlist_image.png')
playlist_photo2 = open('https://tonify-seeds.s3.amazonaws.com/default_playlist_image.png')
playlist_photo3 = open('https://tonify-seeds.s3.amazonaws.com/default_playlist_image.png')
